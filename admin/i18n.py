...
UK: dict[str, str] = {
    ...
    "pg.brief.h1": "Бріф",
    "pg.chat.h1": "AI-чат",
    "pg.chat.soon": "Чат над базою знань — у розробці",
    "pg.chat.hint": "Поки що користуйся пошуком у Базі знань",
    "pg.chat.sub": "Питання до бази знань живою мовою — у розробці",
    "pg.chat.about": "Тут можна буде питати архів форумів звичайною мовою: модель сама перебере кілька формулювань, прочитає теми цілком і покаже джерела. Поки що те саме доступне повнотекстовим пошуком.",
